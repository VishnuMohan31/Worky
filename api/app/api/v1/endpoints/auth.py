...
async def get_current_user_info(
    ...
    return UserResponse(
        ...
        primary_role=current_user.primary_role or current_user.role,
        secondary_roles=current_user.secondary_roles or [],
        is_contact_person=current_user.is_contact_person or False,
